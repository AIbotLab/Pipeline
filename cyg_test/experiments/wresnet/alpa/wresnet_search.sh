# 使用 ./wresnet_search num_hosts num_devices_per_host
cd ../../../..
...
# 定义输出文件和配置文件路径
OUTPUT_DATA_FILE_PATH="cyg_test/experiments/results/wresnet_alpa_search_${num_gpus}.csv"
WRESNET_ALPA_LOG_FILE_PATH="cyg_test/experiments/wresnet/alpa/log/wresnet_search_log_${num_gpus}.txt"
