...
# 定义输出文件和配置文件路径
OUTPUT_DATA_FILE_PATH="cyg_test/experiments/results/wresnet_alpa_${num_gpus}.csv"
WRESNET_ALPA_LOG_FILE_PATH="cyg_test/experiments/wresnet/alpa/log/wresnet_test_log_${num_gpus}.txt"
