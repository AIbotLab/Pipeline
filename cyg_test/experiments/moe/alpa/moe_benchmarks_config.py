...
alpa_moe_best_suite = {
    ...
    2:
        [get_solution_case(moe_specs["380M"], 64, 16, 8, [[0, 1, 2, 3], [4, 5, 6, 7]],
...
alpa_moe_search_suite = {
    2: (get_search_cases(moe_specs["380M"],16, [4,8,16], [4,8],auto_stage_option,prefer_reduce_scatter,use_remat,)
        ),
