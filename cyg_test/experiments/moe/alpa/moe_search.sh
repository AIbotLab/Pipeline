...
# 定义输出文件和配置文件路径
OUTPUT_DATA_FILE_PATH="cyg_test/experiments/results/moe_alpa_search_${num_gpus}.csv"
MOE_ALPA_LOG_FILE_PATH="cyg_test/experiments/moe/alpa/log/moe_search_log_${num_gpus}.txt"
