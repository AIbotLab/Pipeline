# 使用 ./moe_signal num_hosts num_devices_per_host
cd ../../../..
...
# 定义输出文件和配置文件路径
OUTPUT_DATA_FILE_PATH="cyg_test/experiments/results/moe_alpa_signal_${num_gpus}.csv"
MOE_ALPA_LOG_FILE_PATH="cyg_test/experiments/moe/alpa/log/moe_signal_log_${num_gpus}.txt"
