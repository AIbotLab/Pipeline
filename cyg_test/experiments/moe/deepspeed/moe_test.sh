...
# 定义输出文件和配置文件路径
OUTPUT_DATA_FILE_PATH="cyg_test/experiments/results/moe_deepspeed_${num_gpus}.csv"
MOE_DEEPSPEED_LOG_FILE_PATH="cyg_test/experiments/moe/deepspeed/log/moe_test_log_${num_gpus}.txt"
