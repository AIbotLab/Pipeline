...
if __name__ == "__main__":
    ...
    heads = [
            "Type", "method", "seq_len", "hidden_size", "num_layers", "num_heads", "vocab_size", 
            "GPU", "BatchSize", "Microbatch", 
            "prefer_reduce_scatter", "use_remat", "dp_size", "tensor_mp_size", "pipeline_mp_size", "force_batch_dim_mapping"
